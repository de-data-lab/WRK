...
events_summary <- events_summary %>%
  mutate(hovertext = str_glue("In {month_abb}, {year}, {pct_per_month} of events were held at {location}"))
...
ggplotly(event_counts_plot, tooltip = "text") %>% 
  ...
  layout(legend = list(itemclick = FALSE))
```
